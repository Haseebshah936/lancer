...
import PInfoPersonalDetailsAndSkills from "./pages/PInfoPersonalDetailsAndSkills";
import PInfoExperienceAndEducation from './pages/PInfoExperienceAndEducation';
import PInfoProjectsAndRewards from './pages/PInfoProjectsAndRewards';
function App(props) {
